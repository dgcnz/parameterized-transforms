...
@pytest.mark.parametrize(
    "size, brightness, contrast, saturation, hue, channels, tx_mode, default_params_mode",
    list(
        product(
            [
                (
...
def test_tx_on_PIL_images(
    size: t.Tuple[int],
    brightness: t.Union[float, t.List[float], t.Tuple[float, float]],
    contrast: t.Union[float, t.List[float], t.Tuple[float, float]],
    saturation: t.Union[float, t.List[float], t.Tuple[float, float]],
    hue: t.Union[float, t.List[float], t.Tuple[float, float]],
    ...
    list(
        product(
            ...
            [
                (1,),
                (3,),
                # (4,),  # This creates issues
                # (None,),  # This creates issues
            ],
            ["CASCADE", "CONSUME"],
            [
                ptc.DefaultParamsMode.UNIQUE,
